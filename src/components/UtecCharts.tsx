...
const getRegionalFromRpa = (rpaString: string): string => {
  const match = rpaString.match(/\d+/);
...
export default function UtecCharts({ utecs, educationalUnits = [], isDarkMode = false }: UtecChartsProps) {
